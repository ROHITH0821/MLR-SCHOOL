    ...
    <div className="home" style={{ color: '#1a1a1a' }}>
      <section className="hero-modern">
        ...
        <div className="container hero-centered-container">
          ...
          >
            <motion.h1 variants={fadeUpVariant} className="hero-brand-name">
              Malla Reddy School
            </motion.h1>
            <motion.p variants={fadeUpVariant} className="hero-brand-tagline">
              Empowering Minds, Shaping the Future
            </motion.p>
            <motion.div variants={fadeUpVariant} className="hero-modern-btns hero-modern-btns--cta">
              <Link href="/admission" className="btn-primary squishy-btn hero-cta">
                Start Admissions
              </Link>
            </motion.div>
          </motion.div>
      ...
      <section
        ...
        style={{ backgroundColor: '#ffffff', overflow: 'hidden', padding: '6rem 0' }}
      >
      ...
      <section
        className="section stats-section text-center text-white"
        style={{
          ...
          >
            {[
              ...
              <motion.div key={idx} variants={popVariant} className="stat-card-modern">
                ...
                <p className="stat-label" style={{ color: '#cbd5e1' }}>
                  {stat.label}
                </p>
              </motion.div>
            ))}
        ...
        <div className="container">
          ...
          >
            {[
              {
                title: 'Pre-Primary',
                desc: 'Play-based learning focusing on foundational skills and curiosity.',
                icon: <Star size={32} />,
              },
              {
                title: 'Primary',
                desc: 'Interactive environment encouraging creativity and core academic growth.',
                icon: <BookOpen size={32} />,
              },
              {
                title: 'Secondary',
                desc: 'Comprehensive curriculum emphasizing analytical thinking and application.',
                icon: <Microscope size={32} />,
              },
              {
                title: 'High School',
                desc: 'Rigorous preparation for board exams and global career pathways.',
              ...
              <motion.div
                ...
                style={{
                  background: '#ffffff',
                  borderColor: '#e2e8f0',
                  boxShadow: '5px 5px 0 #94a3b8',
                }}
              >
                <div
                  className="blob-card-icon"
                  style={{ background: '#f1f5f9', margin: '0 auto 1.5rem auto' }}
                >
                ...
                <p className="blob-desc" style={{ color: '#64748b' }}>
                  {prog.desc}
                </p>
              </motion.div>
            ))}
            ...
            {[
              {
                ...
                img: 'https://images.unsplash.com/photo-1577896851231-70ef18bcee14?q=80&w=600&auto=format&fit=crop',
                desc: 'Digitally equipped rooms to make learning interactive and fun.',
              },
              {
                title: 'Advanced Labs',
                img: 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?q=80&w=600&auto=format&fit=crop',
                desc: 'State-of-the-art Science and Robotics labs for practicals.',
              },
              {
                title: 'Sports Complex',
                img: 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?q=80&w=600&auto=format&fit=crop',
                desc: 'Expansive fields and courts for physical excellence.',
              },
              {
                title: 'Campus Safety',
                img: 'https://images.unsplash.com/photo-1588072432836-e10032774350?q=80&w=600&auto=format&fit=crop',
                desc: '24/7 security with full CCTV coverage and guards.',
              },
            ].map((fac, idx) => (
              <motion.div
                key={idx}
              ...
              >
                ...
                >
                  ...
                  <p className="notebook-desc" style={{ color: '#64748b', lineHeight: '1.6' }}>
                    {fac.desc}
                  </p>
                </div>
              </motion.div>
